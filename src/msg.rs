...
mod tests {
    ...
    fn test_has_prevote_msg() {
        let vote: Msg = Msg::MsgExchangeRateVote(MsgExchangeRateVote {
            ...
            feeder: TerraAddress {
                0: Address::from_bech32("terra1grgelyng2v6v3t8z87wu3sxgt9m5s03x259evd").unwrap(),
            },
            validator: TerraValidatorOperatorAddress {
                0: Address::from_bech32("terravaloper1grgelyng2v6v3t8z87wu3sxgt9m5s03x2mfyu7")
                    .unwrap(),
            },
        });
